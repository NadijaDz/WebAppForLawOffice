...
namespace Advokati.WebAPI.Migrations
{
    ...
    [Migration("20201015122349_dodavanjetabelezapisnikrocista")]
    partial class dodavanjetabelezapisnikrocista
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Advokati.WebAPI.Database.ZapisnikRocista", b =>
                {
                    b.Property<int>("ZapisnikRocistaId")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.HasKey("ZapisnikRocistaId");

                    b.HasIndex("RocisteID");

                    b.ToTable("ZapisnikRocista");
                });
            ...
            modelBuilder.Entity("Advokati.WebAPI.Database.Postavke", b =>
                {
                    b.HasOne("Advokati.WebAPI.Database.Korisnici", "Korisnici")
                        .WithMany()
            ...
            modelBuilder.Entity("Advokati.WebAPI.Database.ZapisnikRocista", b =>
                {
                    b.HasOne("Advokati.WebAPI.Database.Rocista", "Rocista")
                        .WithMany()
