...
namespace NotificationServiceV1
{
    public class ServiceLog
    {
        ...
        /// <param name="Message"></param>  
        public static void SendEmail(Advokati.Model.Predmeti predmet)
        {
            //Reading sender Email credential from web.config file  
            ServiceLog.WriteErrorLog("poslano doslo");
            string subject = "Opomena za uplatu";
            string body = "Poštovani molimo Vas da uplatite vaš presotali dug za predmet: " + predmet.NazivPredmeta;
            string FromMail = "testRS1test123@gmail.com";
          //  string emailFormAdvokat = "nadija.dziho@edu.fit.ba";
            string emailTo = predmet.Email;
